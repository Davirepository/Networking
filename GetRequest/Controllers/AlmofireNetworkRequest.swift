...
class AlomofireNetworkRequest {
    ...
    // свойтства для вывода хода изображения загрузки
    ...
    static func postRequest(url: String, completion: @escaping (_ courses: [Course])->()) {
        ...
        "link": "http://swiftbook.ru/contents/our-first-applications/",
        "imageUrl": "http://swiftbook.ru//wp-content/uploads/sites/2/2018/08/notifications-course-with-background.png",
        "numberOfLessons": "10",
        "numberOfTests": "10"
        ]
    ...
    static func putRequest(url: String, completion: @escaping (_ courses: [Course])->()) {
        ...
        let userData: [String: Any] = [
            "name": "Network Request with Alomofire",
            "link": "http://swiftbook.ru/contents/our-first-applications/",
            "imageUrl": "http://swiftbook.ru//wp-content/uploads/sites/2/2018/08/notifications-course-with-background.png",
            "numberOfLessons": "10",
            "numberOfTests": "10"
            ...
            multipartFormData.append(data, withName: "image")
               ...
               headers: httpHeaders) { (encodingCompletion) in
                ...
                switch encodingCompletion {
                    ...
                    print(streamFileURL ?? "streamFileURL")
